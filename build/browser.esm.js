...
class ZqField {
    constructor(p) {
        ...
        this.bitLength = bitLength$7(this.p);
...
const { bitLength: bitLength$5, modInv: modInv$2, modPow: modPow$1, isPrime, isOdd: isOdd$4, square } = bigint;
...
var build_f1m = function buildF1m(module, _q, _prefix, _intPrefix) {
    ...
    const pR2 = module.alloc(utils$6.bigInt2BytesLE(square(1n << BigInt(n64*64)) % q, n8));
...
var build_f1 = function buildF1(module, _q, _prefix, _f1mPrefix, _intPrefix) {
    ...
    const f1mPrefix = buildF1m$3(module, q, _f1mPrefix, intPrefix);
...
const buildF1$2 =build_f1;
const buildF2m$2 =build_f2m;
const buildF3m$2 =build_f3m;
const buildCurve$2 =build_curve_jacobian_a0;
const buildFFT$3 = build_fft;
const buildPol$2 = build_pol;
const buildQAP$2 = build_qap;
const buildApplyKey$2 = build_applykey;
...
var build_bn128 = function buildBN128(module, _prefix) {
    ...
    const f1mPrefix = buildF1m$2(module, q, "f1m");
    buildF1$2(module, r, "fr", "frm");
    ...
    buildApplyKey$2(module, "frm_batchApplyKey", "fmr", "frm", n8, n8, n8, "frm_mul");
    buildApplyKey$2(module, "g1m_batchApplyKey", "g1m", "frm", n8*3, n8*3, n8, "g1m_timesFr");
    buildApplyKey$2(module, "g1m_batchApplyKeyMixed", "g1m", "frm", n8*2, n8*3, n8, "g1m_timesFrAffine");
    buildApplyKey$2(module, "g2m_batchApplyKey", "g2m", "frm", n8*2*3, n8*3*2, n8, "g2m_timesFr");
    buildApplyKey$2(module, "g2m_batchApplyKeyMixed", "g2m", "frm", n8*2*2, n8*3*2, n8, "g2m_timesFrAffine");
    ...
    const f6mPrefix = buildF3m$2(module, prefix+"_mulNR6", "f6m", "f2m");
    ...
    const ftmPrefix = buildF2m$2(module, prefix+"_mulNR12", "ftm", f6mPrefix);
...
var build_bls12381 = function buildBLS12381(module, _prefix) {
    ...
    const f1mPrefix = buildF1m$1(module, q, "f1m", "intq");
    buildF1$1(module, r, "fr", "frm", "intr");
    ...
    buildApplyKey$1(module, "frm_batchApplyKey", "fmr", "frm", n8r, n8r, n8r, "frm_mul");
    buildApplyKey$1(module, "g1m_batchApplyKey", "g1m", "frm", n8q*3, n8q*3, n8r, "g1m_timesFr");
    buildApplyKey$1(module, "g1m_batchApplyKeyMixed", "g1m", "frm", n8q*2, n8q*3, n8r, "g1m_timesFrAffine");
    buildApplyKey$1(module, "g2m_batchApplyKey", "g2m", "frm", n8q*2*3, n8q*3*2, n8r, "g2m_timesFr");
    buildApplyKey$1(module, "g2m_batchApplyKeyMixed", "g2m", "frm", n8q*2*2, n8q*3*2, n8r, "g2m_timesFrAffine");
    ...
    const f6mPrefix = buildF3m$1(module, f2mPrefix+"_mulNR", "f6m", "f2m");
    ...
    const ftmPrefix = buildF2m$1(module, f6mPrefix+"_mulNR", "ftm", f6mPrefix);
...
var build_bls12377 = function buildBLS12377(module, _prefix) {
    ...
    const pG1b = module.alloc(utils$1.bigInt2BytesLE( toMontgomery(1n), f1size ));
    ...
    function buildMulByXi() {
        ...
        const c = f.getCodeBuilder();
        // q - 5n = -5 mod q
        const pXi = module.alloc(utils$1.bigInt2BytesLE(toMontgomery(q-5n), f1size));
        f.addCode(
    ...
    const pG2b = module.alloc([
        ...
        ...utils$1.bigInt2BytesLE( toMontgomery(0x10222f6db0fd6f343bd03737460c589dc7b4f91cd5fd889129207b63c6bf8000dd39e5c1ccccccd1c9ed9999999999an), f1size )
    ]);
    ...
    function build_mulNR2() {
        ...
        const pInvXi = module.alloc(utils$1.bigInt2BytesLE(toMontgomery(0x10222f6db0fd6f343bd03737460c589dc7b4f91cd5fd889129207b63c6bf8000dd39e5c1ccccccd1c9ed9999999999an), f1size));
    ...
    function buildFrobeniusMap(n) {
        ...
        const gamma = 0xe0c97ad7fbdab63937b3ebd47e0a1b36a986deef71f15c288ed7951a488e3b332941cfc8f883faffca93e41f1603cfn;
        ...
        for (let i=0; i<6; i++) {
            ...
            const pCoef = module.alloc([
                ...utils$1.bigInt2BytesLE(toMontgomery(coefScalar), n8q),
                ...utils$1.bigInt2BytesLE(toMontgomery(0n), n8q),
            ]);
    ...
    function buildInGroupG2() {
        ...
        const pRScalar = c.i32_const(module.alloc(utils$1.bigInt2BytesLE(r, n8r)));
...
var buildBls12377$1 = build_bls12377;
...
export { BigBuffer, ChaCha, EC, ZqField as F1Field, F2Field, F3Field, PolField, Scalar, ZqField, buildBls12377, buildBls12381, buildBn128, getCurveFromName, getCurveFromQ, getCurveFromR, utils };
